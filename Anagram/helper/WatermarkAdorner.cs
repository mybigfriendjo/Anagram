...
namespace Anagram.helper
{
    internal class WatermarkAdorner : Adorner
    {
        ...
        /// </summary>
        private Control Control { get { return (Control) AdornedElement; } }
        ...
        public WatermarkAdorner(UIElement adornedElement, object watermark) : base(adornedElement)
        {
            ...
            contentPresenter.Margin =
                new Thickness(Control.Margin.Left + Control.Padding.Left, Control.Margin.Top + Control.Padding.Top, 0, 0);
        ...
        protected override Visual GetVisualChild(int index) { return contentPresenter; }
